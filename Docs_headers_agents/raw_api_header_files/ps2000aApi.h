...
/// <summary>
/// The capture state of the device.
/// </summary>
typedef enum enPS2000ACaptureState
{
  /// <summary>
  /// A default value to indicate no state determined.
  /// </summary>
  PS2000A_CAPTURE_STATE_NONE = 0,
  /// <summary>
  /// There is no capture running or the capture has completed.
  /// </summary>
  PS2000A_CAPTURE_STATE_IDLE = 1,
  /// <summary>
  /// The device is capturing pre-trigger samples.
  /// </summary>
  PS2000A_CAPTURE_STATE_PRE_TRIGGER = 2,
  /// <summary>
  /// Capture is waiting for a trigger condition to become valid.
  /// </summary>
  PS2000A_CAPTURE_STATE_WAIT_FOR_TRIGGER = 3,
  /// <summary>
  /// The device is capturing post-trigger samples.
  /// </summary>
  PS2000A_CAPTURE_STATE_POST_TRIGGER = 4,
} PS2000A_CAPTURE_STATE;
...
/// </summary>
/// <param name="handle">Device identifier returned by ps2000aOpenUnit.</param>
/// <param name="captureState">Output: The current capture state of the device:
///	   None (0): the driver was unable to get the information from the device
///	   Idle (1): - the device is not currently capturing
///	   Pre Trigger Samples (2): collecting the pre trigger samples
///	   Wait For Trigger (3): waiting for a trigger to fire
///	   Post Trigger Samples (4): collecting the post trigger samples
///	</param>
/// <returns>
/// PICO_OK
/// PICO_NULL_PARAMETER
...
///	PICO_DRIVER_FUNCTION
/// </returns>
PREF0 PREF1 PICO_STATUS PREF2 PREF3(ps2000aGetCaptureState)
(
	int16_t handle,
	PS2000A_CAPTURE_STATE * captureState
);
