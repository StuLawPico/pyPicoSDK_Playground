...
typedef enum enPS4000AAccelerometerAxis
{
  PS4000A_AXIS_X,
  PS4000A_AXIS_Y,
  PS4000A_AXIS_Z
} PS4000A_ACCELEROMETER_AXIS;
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3(ps4000aSetAccelerometerProbeAxis)
(
	int16_t handle, 
	PS4000A_CHANNEL channel,
	PS4000A_ACCELEROMETER_AXIS axis
	);
