...
class PicoScopeBase:
    ...
    def get_values_bulk(
        ...
        Example:
            >>> samples, overflow = scope.get_values_bulk(
            ...     0, 1024, 0, 3, 1, RATIO_MODE.AVERAGE)
        """
    ...
    def get_values_bulk_async(
        ...
        Example:
            >>> scope.get_values_bulk_async(
            ...     0, 1024, 0, 3, 1, RATIO_MODE.AVERAGE, callback, None)
        """
    ...
    def trigger_within_pre_trigger_samples(self, state: int) -> None:
        ...
        Args:
            state: See :class:`PICO_TRIGGER_WITHIN_PRE_TRIGGER`.
        """
    ...
    def siggen_filter(self, filter_state: int) -> None:
        """Enable or disable the signal generator output filter.

        Args:
            filter_state: See :class:`PICO_SIGGEN_FILTER_STATE`.
        """
    ...
    def siggen_limits(self, parameter: int) -> dict:
